...
## 2026-05-31 - `未提交` - `fix(ui): 每轮保留 Agent 思考过程并中文化字段`
...
## 2026-05-31 - `未提交` - `feat(route-ui): 路线卡展示站点间交通信息`
...
## 2026-05-31 - `未提交` - `fix(stream): Agent 思考步骤实时刷出`
...
## 2026-05-31 - `未提交` - `fix(agent): 相对省钱诉求不再覆盖硬预算`
...
## 2026-05-31 - `未提交` - `fix(agent): 明确重规划意图不再重复澄清`
...
## 2026-05-31 - `未提交` - `fix(agent): 校准意图置信度并解释来源`
...
## 2026-05-31 - `未提交` - `feat(agent): 接入意图澄清策略层`
...
## 2026-05-31 - `未提交` - `feat(profile): 扩展用户画像维度并接入 POI 排序`
...
## 2026-05-31 - `未提交` - `feat(profile): 接入 JSON 用户画像运行时存储`
...
## 2026-05-30 - `未提交` - `feat(agent): 区分全量重规划和局部重规划`
